...
def format_crossover_block(segments: list[Segment]) -> str:
    ...
    lines = [
        ...
        "",
        "Top fragments from prior iterations, grouped by family. Recombine —",
        "extract the *winning piece* of each (window choice, normalization shape,",
        "signal direction, liquidity term) and synthesize a NEW expression that",
        "fuses ≥2 of them. Do NOT just re-submit any of these alphas.",
        "",
